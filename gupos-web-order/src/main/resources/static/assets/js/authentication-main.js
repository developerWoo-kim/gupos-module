(function () {
    ...
    if (localStorage.vertixrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "../assets/bootstrap/libs/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "../assets/bootstrap/libs/bootstrap/css/bootstrap.min.css");
    }
