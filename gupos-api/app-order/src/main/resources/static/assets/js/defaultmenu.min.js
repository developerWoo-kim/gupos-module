...
function setNavActive() {
  ...
  // debugger;
  // var findMiIndex = url.indexOf("mi=")+3;
  // var findMiIndexUrl = url.substring(findMiIndex)
  // var currentMi = url.substring(url.indexOf("mi=")+3, findMiIndexUrl.indexOf("&") == -1 ? url.length : findMiIndex + findMiIndexUrl.indexOf("&"));
  var currentMi = document.getElementById("currentMi").value
  ...
  sidemenuItems.forEach((e) => {
    ...
    // }
    if (e.getAttribute("side-mi") === currentMi) {
